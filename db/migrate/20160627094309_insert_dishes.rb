class InsertDishes < ActiveRecord::Migration
  def up
    [{name: "салат &#171;цезар&#187;", label: "Хіт сезону", price: 110, published: true,
     ...
     {name: "паста з лососем", label: "Пропозиція тижня", price: 120, published: true,
     ...
     {name: "форель", label: "Страва від шефа", price: 40, published: true,
     ...
     {name: "плов", label: "Краща пропозиція", price: 55, published: true,
     ...
     { name: "гарбузовий крем-суп", label: "Страва від шефа", price: 55, published: true,
